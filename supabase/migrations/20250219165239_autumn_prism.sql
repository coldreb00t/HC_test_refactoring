/*
  # Add client profile features
  
  1. Schema Updates
    - Add new columns to clients table
    - Create tables for measurements, documents, programs, and payments
    - Update client_profiles view with new fields
  
  2. Security
    - Enable RLS on all new tables
    - Add appropriate policies for trainers and clients
*/

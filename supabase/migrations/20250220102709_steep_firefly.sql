/*
  # Consolidate client data into a single table

  1. Changes
    - Drop existing client-related tables
    - Create a new consolidated clients table
    - Add RLS policies
...
DROP TABLE IF EXISTS client_activity_reports CASCADE;
DROP TABLE IF EXISTS client_meals CASCADE;
DROP TABLE IF EXISTS clients CASCADE;

-- Create consolidated clients table

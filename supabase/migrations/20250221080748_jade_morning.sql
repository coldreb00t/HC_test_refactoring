/*
  # Exercise Management System Setup

  1. Table Structure
    - Creates exercises table with all necessary fields
    - Includes validation for required fields and arrays
  ...
  2. Security
    ...
    - Creates policies for:
      ...
      - Only trainers can manage exercises

  3. Sample Data
    - Inserts basic exercises as a starter set
*/

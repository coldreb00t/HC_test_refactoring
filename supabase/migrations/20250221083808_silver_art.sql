...
DROP POLICY IF EXISTS "exercises_trainer_policy" ON exercises;
DROP POLICY IF EXISTS "set_details_trainer_policy" ON set_details;
DROP POLICY IF EXISTS "set_details_client_policy" ON set_details;
...
CREATE POLICY "exercises_view_policy"
ON exercises
FOR SELECT
TO authenticated
USING (true);  -- Allow all authenticated users to view exercises

CREATE POLICY "exercises_manage_policy"
ON exercises
FOR ALL
TO authenticated
USING (
...
CREATE POLICY "set_details_manage_policy"
ON set_details
FOR ALL
TO authenticated
USING (
...
CREATE POLICY "set_details_view_policy"
ON set_details
FOR SELECT
TO authenticated
USING (
